  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: "rgba(26, 58, 107, 0.72)" }}
      />
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        >
          <p
            className="text-sm sm:text-base font-semibold uppercase tracking-widest mb-4"
          ...
          >
            Tu ferretería de<br />
            <span style={{ color: "#E8600A" }}>confianza</span> en Quito
          </h1>
          <p
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-md text-base font-semibold text-white shadow-lg transition-all"
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.97 }}
              className="inline-flex items-center justify-center px-8 py-4 rounded-md text-base font-semibold border-2 text-white transition-all hover:bg-white/10"
